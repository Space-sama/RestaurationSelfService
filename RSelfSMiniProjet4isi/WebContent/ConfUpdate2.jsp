...
<div class="card">
 ...
 <div class="card-header">
 		<div class="alert alert-success alert-dismissible">
                <i class="icon fas fa-check"></i>La modification de ce boisson a été bien faite !
                </div>
 ...
 <input type="text" name="id" class="form-control" value="${confBM.idBoiss}" disabled="disabled"/>
</div>

<div class="form-group">
 <label class="control-label" style="color: blue;">Nom : </label><br />
 <label class="control-label"><c:out value="${confBM.nomBoiss}"></c:out> </label>
 </div>
 
 <%-- <div class="form-group">
 <label class="control-label" style="color: blue;">Description : </label>
 <label class="control-label"><c:out value="${confBM.description}"></c:out></label>
 </div> --%>

 <div class="form-group">
 <label class="control-label" style="color: blue;">Prix : </label><br />
 <label class="control-label"><c:out value="${confBM.prixBoiss} DHS "></c:out> </label>
 </div>
