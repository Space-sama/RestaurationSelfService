...
<div class="card">
 ...
 <input type="text" name="id" class="form-control" value="${confPM.idPlat}" disabled="disabled"/>
</div>

<div class="form-group">
 <label class="control-label" style="color: blue;">Nom : </label><br />
 <label class="control-label"><c:out value="${confPM.nomPlat}"></c:out> </label>
 </div>
 
<!--  <div class="form-group"> -->
<!--  <label class="control-label" style="color: blue;">Description : </label> -->
<%--  <label class="control-label"><c:out value="${confPM.description}"></c:out></label> --%>
<!--  </div> -->

 <div class="form-group">
 <label class="control-label" style="color: blue;">Prix : </label><br />
 <label class="control-label"><c:out value="${confPM.prixPlat} DHS "></c:out> </label>
